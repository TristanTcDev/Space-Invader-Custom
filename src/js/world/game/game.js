...
function spawnEnnemy(scene, camera) {
    ...
    switch (Level.wave) {
      ...
      case 4:
        ...
        Ennemy.projectilespeedEnnemy += 1;
        Ennemy.ennemySpeed += 1;
        Ennemy.projectilesmaxEnnemy += 2;
        break;
      case 5:
        Level.levelactuelle = JSON.parse(JSON.stringify(Level.lvl5));
        Ennemy.projectilespeedEnnemy += 1.5;
        Ennemy.ennemySpeed += 1;
        Ennemy.projectilesmaxEnnemy += 2;
        break;
      default:
        ...
        document.getElementById("level-container").style.height = "15%";
        document.getElementById("level-container").style.width = "35%";
        document.getElementById("level-text").innerHTML = "PARTIE TERMINER <br> SCORE : " + (Player.score) + "<br> MEILLEUR SCORE : " + (Player.bestScore) + "<br> Appuyer sur entrée pour rejouer";
